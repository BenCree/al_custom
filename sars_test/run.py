...
def ask_oracle(chosen_ones, virtual_library):
    ...
    chosen_ones.cnnaff = -oracle_has_spoken.cnnaff_y.values
...
def report(virtual_library, start_time):
    ...
    best_finds = virtual_library[virtual_library.cnnaff < -6]  #-6 is about 5% of the best cases
...
if __name__ == '__main__':
    ...
    config.selection_config.selection_columns = ["cnnaff", "Smiles"]
    config.model_config.targets.params.feature_column = 'cnnaff'
